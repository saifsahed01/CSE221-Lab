...
vector<vector<int>> InputW, InputU, InputV;
...
inline void prepareInput() {
    ...
    if (batch == 1) {
        ...
        InputS = { 1, 5 };
        InputD = { 2, 3 };
        InputW = { {3, 4, 5, 4}, {3, 3, 4, 3, 4, 1} };
        InputU = { {1, 3, 4}, {1, 4, 1, 6, 4} };
        InputV = { {2, 2, 3}, {2, 1, 6, 2, 6} };
    }
    else if (batch == 2) {
        InputN = { 5, 2 };
        InputM = { 7, 1 };
        InputS = { 3, 1 };
        InputD = { 5, 1 };
        InputW = { {3, 8, 2, 6, 6}, {7, 6} };
        InputU = { {1, 1, 5, 4, 2, 3, 2}, {2} };
        InputV = { {5, 4, 3, 5, 5, 4, 3}, {1} };
    }
    else {
